      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-text-secondary leading-relaxed">
            Hello! I'm Tamir, a driven ETL Developer with a strong foundation in Software Engineering and a knack for crafting efficient data solutions. My journey into tech is fueled by a desire to optimize processes, innovate, and contribute to impactful projects. With a background in Full Stack development, I bring a unique perspective to solving complex data challenges.
          </p>
          {/* Optional: Add a profile image here */}
          {/* <img src={profilePlaceholder} alt="Tamir Refael" className="w-40 h-40 rounded-full mx-auto my-6 border-4 border-accent-1" /> */}
        </motion.div>
