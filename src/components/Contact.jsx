      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-text-secondary mb-8 leading-relaxed">
            I’m always happy to connect with fellow data professionals and developers. Whether you want to discuss ETL challenges, share knowledge, or just say hi — my inbox is always open.
          </p>
          <a
